        ...
        while ($row = $resultado->fetch_object()) {
            ...
            <div class="card">
                ...
                <div class="card_icons">
                    <a href="./PanelAdmin.php?Editar=<?php echo $idMateriales ?>" onclick="activarEditar()"><svg
                    ...
                    <a href="./PanelAdmin.php?borrar=<?php echo $idMateriales ?>" onclick="return ConfirmDelete()"><svg
                            xmlns="http://www.w3.org/2000/svg" height="32" width="28"
